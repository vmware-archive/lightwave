...
#define VMDIR_ERROR_REST_OIDC_UNAVAILABLE             (VMDIR_ERROR_BASE + VMDIR_REST_ERROR_BASE + 2 )     // 9902
#define VMDIR_ERROR_REST_HOST_NOT_FOUND               (VMDIR_ERROR_BASE + VMDIR_REST_ERROR_BASE + 3 )     // 9903
#define VMDIR_ERROR_REST_TRY_AGAIN                    (VMDIR_ERROR_BASE + VMDIR_REST_ERROR_BASE + 4 )     // 9904
#define VMDIR_ERROR_REST_NO_RECOVERY                  (VMDIR_ERROR_BASE + VMDIR_REST_ERROR_BASE + 5 )     // 9905
#define VMDIR_ERROR_REST_NO_DATA                      (VMDIR_ERROR_BASE + VMDIR_REST_ERROR_BASE + 6 )     // 9906
#define VMDIR_ERROR_REST_UNKNOWN_NS_ERROR             (VMDIR_ERROR_BASE + VMDIR_REST_ERROR_BASE + 7 )     // 9907
#define VMDIR_ERROR_REST_UNEXPECTED_RECORDS_NUM       (VMDIR_ERROR_BASE + VMDIR_REST_ERROR_BASE + 8 )     // 9908
#define VMDIR_ERROR_REST_UNEXPECTED_RECORD_TYPE       (VMDIR_ERROR_BASE + VMDIR_REST_ERROR_BASE + 9 )     // 9909
#define VMDIR_ERROR_REST_DNS_FORM_ERR                 (VMDIR_ERROR_BASE + VMDIR_REST_ERROR_BASE + 10 )    // 9910
#define VMDIR_ERROR_REST_DNS_SERV_FAIL                (VMDIR_ERROR_BASE + VMDIR_REST_ERROR_BASE + 11 )    // 9911
#define VMDIR_ERROR_REST_DNS_NXDOMAIN                 (VMDIR_ERROR_BASE + VMDIR_REST_ERROR_BASE + 12 )    // 9912
#define VMDIR_ERROR_REST_DNS_NOTIMPL                  (VMDIR_ERROR_BASE + VMDIR_REST_ERROR_BASE + 13 )    // 9913
#define VMDIR_ERROR_REST_DNS_REFUSED                  (VMDIR_ERROR_BASE + VMDIR_REST_ERROR_BASE + 14 )    // 9914
#define VMDIR_ERROR_REST_DNS_OTHER                    (VMDIR_ERROR_BASE + VMDIR_REST_ERROR_BASE + 15 )    // 9915
