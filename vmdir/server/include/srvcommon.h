...
#define VDIR_ACCESS_IS_ADMIN_OR_DC_GROUP_MEMBER         0x0040

#define VMDIR_IS_ADMIN_OR_DC_GROUP_MEMBERY(accessRoleBitmap) \
    (accessRoleBitmap & VDIR_ACCESS_IS_ADMIN_OR_DC_GROUP_MEMBER)
