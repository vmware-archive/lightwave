...
ldapsearch -h $host -p $port -x -D "cn=Admin,cn=Users,dc=vmware,dc=com" -w 123 -b "" -s subtree "cn=John-1" memberOf
...
ldapsearch -h $host -p $port -x -D "cn=Admin,cn=Users,dc=vmware,dc=com" -w 123 -b "" -s subtree "cn=John-2" memberOf
...
ldapsearch -h $host -p $port -x -D "cn=Admin,cn=Users,dc=vmware,dc=com" -w 123 -b "" -s subtree "cn=John-3" memberOf
...
ldapsearch -h $host -p $port -x -D "cn=Admin,cn=Users,dc=vmware,dc=com" -w 123 -b "" -s subtree "objectClass=groupOfNames" member
...
ldapsearch -h $host -p $port -x -D "cn=Admin,cn=Users,dc=vmware,dc=com" -w 123 -b "" -s subtree "objectClass=foreignSecurityPrincipal" externalObjectId
