...
BuildArch: x86_64
Requires:  coreutils >= 8.22, openssl >= 1.0.2, krb5-libs >= 1.14, cyrus-sasl >= 2.1, likewise-open >= 6.2.11, vmware-directory-client = %{version}
BuildRequires:  coreutils >= 8.22, openssl-devel >= 1.0.2, krb5-libs >= 1.14, cyrus-sasl >= 2.1, likewise-open-devel >= 6.2.11}
