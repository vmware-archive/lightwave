 ...
 * @author Jun Sun
 */
public final class ClientIDToken {
    private final IDToken idToken;

    private ClientIDToken(IDToken idToken) {
    ...
    /* internal */ static ClientIDToken build(
        ...
        return new ClientIDToken(idToken);
    }
