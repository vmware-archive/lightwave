...
public interface IOsSamAdapter
{
    public void LogonUser( String userName, String password );

    List<String> GetLocalUserGroups( String userName, boolean recursive );

    GroupInfo getLocalGroupInfo( String groupName );

    List<GroupInfo> getLocalGroups();

    UserInfo getLocalUserInfo(String userName);
