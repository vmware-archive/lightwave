                    ...
                    retrieveObjectsCollection(
                            ...
                            new IObjectProcessedCallback<IDPConfig>() {
                                        ...
                                        String idpConfigDN, IDPConfig idpConfig)
                                {
                                    ...
                                    LdapValue[] alias = IDPConfigLdapObject.getInstance().getObjectProperty(connection, idpConfigDN,
                                            LdapScope.SCOPE_BASE, null, IDPConfigLdapObject.PROPERTY_ALIAS);
                                    idpConfig.setAlias(ServerUtils.getStringValue(alias));
                                }
                            });
