...
public class DirectoryConfigStore implements IConfigStore {
  ...
  public void addTenant(Tenant tenant, String adminAccountName, char[] adminPwd) throws Exception {
    ...
    try (PooledLdapConnection pooledConnection = borrowConnection()) {
      ...
      String tenantsContainerDn = DirectoryConfigStore.ensureObjectExists(
                                      connection,
                                      identityManagerDn,
  ...
  private TenantCredentialInformation
  getLastSetTenantCred(
      String tenantName,
      String tenantRootDn,
    ...
    Set<String> tenantCredsDns = tenantCredsObj.lookupObjects(
                                      connection,
                                      tenantRootDn,
  ...
  private Collection<List<Certificate>>
  getTenantCertificatesForTenant(
      String tenantName,
      String tenantRootDn,
      ILdapConnectionEx connection
  ) throws Exception {
  ...
  private void
  deleteTenantCredentialsForTenant(
      String tenantName,
      String tenantsRootDn,
      ILdapConnectionEx connection,
      Collection<Certificate> tenantCertificates
    ...
    for (String tenantCredsDn : tenantCredsDns) {
      List<TenantCredentialInformation> tenantCred = tenantCredsObj.searchObjects(
                                                          connection,
                                                          tenantCredsDn,
  ...
  private void
  setTenantTrustedCertificateChainForTenant(
      String tenantName,
      String tenantsRootDn,
      ILdapConnectionEx connection,
      Collection<Certificate> tenantCertificates
  ) throws Exception {
    String tenantCertChainContainerDn = DirectoryConfigStore.ensureObjectExists(
                                            connection,
                                            tenantsRootDn,
    ...
    Set<String> tenantTrustedCertchainDns = tenantTrustedCertChainObj.lookupObjects(
                                                connection,
                                                tenantCertChainContainerDn,
                                                LdapScope.SCOPE_ONE_LEVEL,
                                                null,
    ...
    String tenantTrustedCertChainDn = tenantTrustedCertChainObj.getDnFromObject(
                                            tenantCertChainContainerDn,
  ...
  private void
  deleteTenantTrustedCertificateChainForTenant(
      String tenantName,
      String tenantsRootDn,
      ILdapConnectionEx connection,
      List<Certificate> tenantCertificates
  ) throws Exception {
    String tenantCertChainContainerDn = DirectoryConfigStore.ensureObjectExists(
                                            connection,
                                            tenantsRootDn,
    ...
    Set<String> tenantTrustedCertchainDns = tenantTrusterCerdChainObj.lookupObjects(
                                                connection,
                                                tenantCertChainContainerDn,
                                                LdapScope.SCOPE_ONE_LEVEL,
                                                null,
    ...
    for (String certChainDn : tenantTrustedCertchainDns) {
      List<TenantTrustedCertificateChain> certChain =
          tenantTrusterCerdChainObj.searchObjects(
                                          connection,
                                          certChainDn,
                                          LdapScope.SCOPE_BASE
                                      );
  ...
  public TenantAttributes getTokenPolicyExt(String tenantName) throws Exception {
    ...
    try (PooledLdapConnection pooledConnection = borrowConnection()) {
      ...
      tenantAttributes = tenantAttributesObject.retrieveObject(
                              connection,
                              tenantsRootDn,
                              LdapScope.SCOPE_BASE,
                              null
  ...
  private void setProviderProperty(String tenantName, String providerName, String propertyName,
    ...
    try (PooledLdapConnection pooledConnection = borrowConnection()) {
      ...
      String identityProviderRootDn = IdentityProviderLdapObject.getInstance().lookupObject(
                                          connection,
  ...
  setProviderProperty(
      ...
      String propertyName,
      LdapValue[] propertyValue
  ) throws Exception {
    IdentityProviderLdapObject.getInstance().setObjectPropertyValue(
        connection,
        identityProvidersContainerDn,
        propertyName,
        propertyValue
  ...
  public long getMaximumHoKRefreshTokenLifetime(String tenantName) throws Exception {
    ...
    LdapValue[] value = this.getTenantProperty(
                              tenantName,
  ...
  public PasswordExpiration getPasswordExpirationConfiguration(String tenantName) throws Exception {
    ...
    try (PooledLdapConnection pooledConnection = borrowConnection()) {
      ...
      TenantPasswordExpiration obj = passwordSettings.retrieveObject(
                                          connection,
                                          tenantRootDn,
                                          LdapScope.SCOPE_BASE,
                                          null
  ...
  @Override
  public void
  addCertificateForSystemTenant(String tenantName, Certificate cert, CertificateType certType) throws Exception {
    ValidateUtil.validateNotEmpty(tenantName, "tenantName");
  ...
  @Override
  public void
  addCertificateForNonSystemTenant(String tenantName, Certificate cert, CertificateType certType) throws Exception {
    ValidateUtil.validateNotEmpty(tenantName, "tenantName");
    ValidateUtil.validateNotNull(cert, "idmCert");
  ...
  addCertificateForTenant(
    ...
    try {
      String idmCertificatesContainerDn = DirectoryConfigStore.ensureObjectExists(
                                              connection,
                                              tenantRootDn,
                                              ContainerLdapObject.getInstance(),
      ...
      idmCertObject.createObject(
                      connection,
                      idmCertObject.getDnFromObject(idmCertificatesContainerDn, idmCert),
                      idmCert
      );
    } catch (AlreadyExistsLdapException e) {
      throw new DuplicateCertificateException(
          String.format("addCertificateForTenant failed - Certificate already exists in %s", tenantRootDn)
      );
    }
  }
  ...
  public Collection<Certificate> getAllCertificatesForSystemTenant(String tenantName, CertificateType certType)
    ...
    try (PooledLdapConnection pooledConnection = borrowConnection()) {
      ...
      Set<String> tenantCredsRootDns = lduContainer.lookupObjects(
                                            connection,
                                            lduContainerDn,
      ...
      if (tenantCredsRootDns != null && tenantCredsRootDns.size() != 0) {
        for (String tenantCredsRootDn : tenantCredsRootDns) {
          Collection<Certificate> certsInLdu = getAllCertificatesForTenant(
                                                    tenantName,
                                                    tenantCredsRootDn,
                                                    connection,
                                                    certType
  ...
  private Collection<Certificate> getAllCertificatesForTenant(String tenantName, String tenantRootDn,
    ...
    String certTypeFilter = String.format(
                                  "(%s=%s)",
                                  IdmCertificateLdapObject.PROPERTY_CERT_TYPE, // attribute
                                  LdapFilterString.encode(certType.toString()) // name
                              );
    Collection<IdmCertificate> certs = retrieveObjectsCollection(
                                            connection,
                                            tenantRootDn,
                                            ContainerLdapObject.CONTAINER_IDM_CERTIFICATES,
                                            certTypeFilter,
  ...
  getTrustedCertificatesForTenant(
      String tenantName,
      String tenantRootDn,
      ILdapConnectionEx connection
  ) throws Exception {
    ...
    Collection<List<Certificate>> trustedCertChains = getTenantCertificatesForTenant(
                                                            tenantName,
                                                            tenantRootDn,
                                                            connection
                                                        );
  ...
  private Collection<Certificate>
  getStsIssuersCertificatesForTenant(
      String tenantName,
      String tenantRootDn,
      ILdapConnectionEx connection
  ) throws Exception {
  ...
  private void
  deleteSingleCertForTenant(
      String tenantName,
      String tenantsRootDn,
      ILdapConnectionEx connection,
      String fingerprint,
      CertificateType certType,
      boolean isCertExistInCertChains
    ...
    String idmCertificateDn = idmCertObject.lookupObject(
                                  connection,
  ...
  private void deleteStsCertificateForTenant(String tenantName, String tenantsRootDn, ILdapConnectionEx connection,
    ...
    List<Certificate> activeCerts = this.getTenantCertificateForTenant(
                                        tenantName,
                                        tenantsCertChainRootDn,
                                        connection
                                    );
    ...
    Collection<List<Certificate>> certChains = this.getTenantCertificatesForTenant(
                                                    tenantName,
                                                    tenantsCertChainRootDn,
                                                    connection
                                                );
  ...
  public void addRelyingParty(String tenantName, RelyingParty rp) throws Exception {
    ...
    try (PooledLdapConnection pooledConnection = borrowConnection()) {
      ...
      String relyingPartiesContainerDn = DirectoryConfigStore.ensureObjectExists(
                                              connection,
                                              tenantsRootDn,
  ...
  public void deleteRelyingParty(String tenantName, String rpName) throws Exception {
    ...
    try (PooledLdapConnection pooledConnection = borrowConnection()) {
      ...
      if (ServerUtils.isNullOrEmpty(relyingPartiesContainerDn) == false) {
        ...
        String relyingPartyDn = relyingPartyConfig.lookupObject(
                                    connection,
  ...
  public RelyingParty getRelyingParty(String tenantName, String rpName) throws Exception {
    ...
    try (PooledLdapConnection pooledConnection = borrowConnection()) {
      ...
      if (ServerUtils.isNullOrEmpty(relyingPartiesContainerDn) == false) {
        ...
        relyingParty = relyingPartyConfig.retrieveObject(
                            connection,
                            relyingPartiesContainerDn,
                            LdapScope.SCOPE_ONE_LEVEL,
                            rpName
        ...
        if (relyingParty != null) {
          ...
          relyingParty.setAssertionConsumerServices(
              DirectoryConfigStore.retrieveRelyingPartyAssertionConsumerServices(connection, relyingPartyDn)
          );
          relyingParty.setAttributeConsumerServices(
              DirectoryConfigStore.retrieveRelyingPartyAttributeConsumerServices(connection, relyingPartyDn)
          );
          relyingParty.setSingleLogoutServices(
              DirectoryConfigStore.retrieveRelyingPartySingleLogoutServices(connection, relyingPartyDn)
          );
          relyingParty.setSignatureAlgorithms(
              DirectoryConfigStore.retrieveRelyingPartySignatureAlgorithms(connection, relyingPartyDn)
          );
        }
      }
  ...
  public RelyingParty getRelyingPartyByUrl(String tenantName, String url) throws Exception {
    ...
    try (PooledLdapConnection pooledConnection = borrowConnection()) {
      ILdapConnectionEx connection = pooledConnection.getConnection();
      RelyingPartyLdapObject relyingPartyConfig = RelyingPartyLdapObject.getInstance();
      String urlFilter = relyingPartyConfig.getInSetSearchFilter(
      ...
      Collection<RelyingParty> relyingParties = DirectoryConfigStore.getRelyingParties(
                                                    this,
                                                    connection,
                                                    tenantName,
                                                    urlFilter
  ...
  private static OIDCClient convertToMultiTenantOidcMetaData(String tenantName, OIDCClient oidcClient) throws URISyntaxException {
    ...
    return new OIDCClient.Builder(
                ...
                .postLogoutRedirectUriTemplates(oidcClient.getPostLogoutRedirectUriTemplates())
                .build();
  }
  ...
  public Collection<OIDCClient> getOIDCClients(String tenantName) throws Exception {
    ...
    try (PooledLdapConnection pooledConnection = borrowConnection()) {
      return DirectoryConfigStore.getOIDCClients(
                  this,
  ...
  public void addResourceServer(String tenantName, ResourceServer resourceServer) throws Exception {
    ...
    try (PooledLdapConnection pooledConnection = borrowConnection()) {
      ...
      String resourceServerDn = resourceServerLdapObject.getDnFromObject(
  ...
  private static Collection<OIDCClient>
  getOIDCClients(
    ...
    Collection<OIDCClient> oidcClients = retrieveObjectsCollection(
                                              connection,
                                              tenantsRootDn,
                                              ContainerLdapObject.CONTAINER_OIDC_CLIENTS,
                                              propertyFilter,
  ...
  public void addProvider(String tenantName, IIdentityStoreData idsData) throws Exception {
    ...
    try (PooledLdapConnection pooledConnection = borrowConnection()) {
      ...
      if (idsData.getDomainType() == DomainType.LOCAL_OS_DOMAIN) {
        ...
        Collection<IIdentityStoreData> providers = getProviders(
                                                        tenantName,
  ...
  public void registerExternalIdpConfig(String tenantName, IDPConfig idpConfig) throws Exception {
    ...
    String externalIDPConfigsContainerDn = DirectoryConfigStore.ensureObjectExists(
              connection,
              tenantRootDn,
              ContainerLdapObject.getInstance(),
  ...
  public void removeExternalIdpConfig(String tenantName, String configEntityId) throws Exception {
    ...
    try (PooledLdapConnection pooledConnection = borrowConnection()) {
      ...
      throw new NoSuchExternalIdpConfigException(
          String.format(
  ...
  public Collection<IDPConfig> getExternalIDPConfigs(String tenantName) throws Exception {
    ...
    try (PooledLdapConnection pooledConnection = borrowConnection()) {
      ...
      idpConfigs = retrieveObjectsCollection(
            connection,
            tenantConfigDN,
            ContainerLdapObject.CONTAINER_EXTERNAL_IDP_CONFIGS,
            null,
            IDPConfigLdapObject.getInstance(),
  ...
  private AttributeConfig[] retrieveSubjectFormatMap(ILdapConnectionEx connection, String idpConfigDN) {
    Collection<AttributeMapping> mappings = retrieveObjectsCollection(
                  connection,
                  idpConfigDN,
                  ContainerLdapObject.CONTAINER_EXTERNAL_IDP_SUBJECT_FORMAT_MAPPINGS,
                  AttributeMappingLdapObject.getInstance(),
  ...
  private Map<TokenClaimAttribute, List<String>>
  retrieveClaimGroupMap(ILdapConnectionEx connection, String idpConfigDN) {
    Collection<AttributeMapping> attMappings = retrieveObjectsCollection(
                        connection,
                        idpConfigDN,
                        ContainerLdapObject.CONTAINER_EXTERNAL_IDP_GROUP_ATTRIBUTE_MAPPINGS,
                        AttributeMappingLdapObject.getInstance(),
  ...
  private boolean isDomainAliasSame(IIdentityStoreData storeDataToAdd, String existingDomainAlias) {
    ...
    return StringUtils.equalsIgnoreCase(
                            storeDataToAdd.getExtendedIdentityStoreData().getAlias(),
                            existingDomainAlias
                        );
  }
  ...
  public void deleteProvider(String tenantName, String providerName) throws Exception {
    ...
    try (PooledLdapConnection pooledConnection = borrowConnection()) {
      ...
      if (ServerUtils.isNullOrEmpty(identityProvidersContainerDn) == false) {
        ...
        String identityProviderDn = identityProviderConfigObject.lookupObject(
                                        connection,
                                        identityProvidersContainerDn,
                                        LdapScope.SCOPE_ONE_LEVEL,
                                        providerName
        ...
        if (ServerUtils.isNullOrEmpty(identityProviderDn) == true) {
          IdentityProviderAlias obj = identityProviderAliasConfigObject.retrieveObject(
                                          connection,
                                          identityProvidersContainerDn,
                                          LdapScope.SCOPE_ONE_LEVEL,
                                          providerName
          ...
          if (obj != null) {
            ...
            providerName = ServerUtils.getStringValue(
          ...
          aliasName = ServerUtils.getStringValue(
                          identityProviderConfigObject.getObjectProperty(
                              connection,
                              identityProviderDn,
                              LdapScope.SCOPE_BASE,
        ...
        String defaultProvider = ServerUtils.getStringValue(
                                    DirectoryConfigStore.getTenantProperty(
                                        connection,
                                        tenantsRootDn,
        ...
        if (ServerUtils.isNullOrEmpty(defaultProvider) == false) {
          if ((defaultProvider.equalsIgnoreCase(providerName) == true)
            ...
            DirectoryConfigStore.setTenantProperty(
                                      connection,
                                      tenantsRootDn,
                                      TenantLdapObject.PROPERTY_DEFAULT_PROVIDER,
                                      null
  ...
  public IIdentityStoreData getProvider(String tenantName, String providerName, boolean getInternalInfo)
    ...
    try (PooledLdapConnection pooledConnection = borrowConnection()) {
      ...
      if (ServerUtils.isNullOrEmpty(identityProvidersContainerDn) == false) {
        ...
        if (ServerUtils.isNullOrEmpty(identityProviderDn) == false) {
          IIdentityStoreData provObj = identityProviderConfigObject.retrieveObject(
                                            connection,
                                            identityProviderDn,
                                            LdapScope.SCOPE_BASE,
                                            null
  ...
  @Override
  public Collection<IIdentityStoreData>
  getProviders(
      String tenantName,
    ...
    try (PooledLdapConnection pooledConnection = borrowConnection()) {
      ...
      if (domainTypes.size() > 0) {
        ...
        Collection<IIdentityStoreData> providersList = retrieveObjectsCollection(
              connection,
              tenantsRootDn,
              ContainerLdapObject.CONTAINER_IDENTITY_PROVIDERS,
              domainTypeFilter,
        ...
        if (ServerUtils.isNullOrEmpty(defaultProvider) == false) {
          ...
          if (ServerUtils.isNullOrEmpty(identityProvidersContainerDn) == false) {
            ...
            if (ServerUtils.isNullOrEmpty(providerDn)) {
              providerDn = identityProviderAliasConfigObject.lookupObject(
                                connection,
                                identityProvidersContainerDn,
                                LdapScope.SCOPE_ONE_LEVEL,
                                defaultProvider
  ...
  public boolean registerUpnSuffixForDomain(String tenantName, String domainName, String upnSuffix) throws Exception {
    ...
    String identityProviderDn = IdentityProviderLdapObject.getInstance().lookupObject(
                                    connection,
                                    identityProvidersContainerDn,
                                    LdapScope.SCOPE_ONE_LEVEL,
                                    domainName
    ...
    try {
      ...
      logger.info(String.format(
          "upnSuffix [%s] is already registered for provider [%s]", upnSuffix,
          identityProviderDn));
      added = false;
    } finally {
      pooledConnection.close();
  ...
  public boolean unregisterUpnSuffixForDomain(String tenantName, String domainName, String upnSuffix)
    ...
    if (identityProvidersContainerDn == null) {// Idp not found -- if
      ...
      String msg = String.format(
                        "IdentityProviders container does not exist for tenant [%s]",
                        identityProvidersContainerDn
                    );
      logger.error(msg);
      throw new NoSuchIdpException(msg);
  ...
  public ClientCertPolicy getClientCertPolicy(String tenantName) throws Exception {
    ...
    try (PooledLdapConnection pooledConnection = borrowConnection()) {
      ...
      if (certPolicies != null && certPolicies.size() > 0) {
        ...
        Collection<TenantTrustedCertificateChain> chains = retrieveObjectsCollection(
            connection,
            ClientCertPolicyLdapObject.getInstance().getDnFromObject(
                clientCertPolicyContainerDn,
  ...
  private static HashMap<String, AlternativeOCSPList>
  retrieveSiteOCSPMap(ILdapConnectionEx connection, String certPolicyDn) {
    ...
    Collection<AlternativeOCSPList> altOCSPListColection = retrieveObjectsCollection(
          connection,
          certPolicyDn,
   ...
   * @return
   */
  protected static List<AlternativeOCSP>
  retrieveAlternativeOCSPsForSite(ILdapConnectionEx connection, String altOcspListDn) {
    Collection<TenantAlternativeOCSP> tOcspCollection = retrieveObjectsCollection(
                                                            connection,
                                                            altOcspListDn,
                                                            ContainerLdapObject.CONTAINER_OCSPs,
                                                            TenantAlternativeOCSPLdapObject.getInstance(),
                                                            null
                                                        );
  ...
  @Override
  public void setClientCertPolicy(String tenantName, ClientCertPolicy policy) throws Exception {
    ValidateUtil.validateNotEmpty(tenantName, "tenantName");

    try (PooledLdapConnection pooledConnection = borrowConnection()) {
      ILdapConnectionEx connection = pooledConnection.getConnection();
      String tenantRootDn = this.ensureTenantExists(connection, tenantName);
      String authnPoliciesContainerDn = DirectoryConfigStore.ensureObjectExists(
                                            connection,
                                            tenantRootDn,
                                            ContainerLdapObject.getInstance(),
                                            ContainerLdapObject.CONTAINER_CLIENT_CERT_POLICIES,
      ...
      String certPolicyDn = ClientCertPolicyLdapObject.getInstance().getDnFromCn(
      ...
      if (policy != null) {
        ...
        String trustedCAContainerDn = DirectoryConfigStore.ensureObjectExists(
                                          connection,
                                          certPolicyDn,
                                          ContainerLdapObject.getInstance(),
                                          ClientCertPolicyLdapObject.CONTAINER_CLIENT_CERT_TRUSTED_CA_CERTIFICATES,
        ...
        Set<String> trustedCADns = TenantTrustedCertChainLdapObject.getInstance().lookupObjects(
                                        connection,
        ...
        String trustedCAsDn = String.format(
                                        "cn=%s,%s",
                                        ClientCertPolicyLdapObject.CLIENT_CERT_TRUSTED_CA_CERTIFICATES_DEFAULT_NAME,
                                        trustedCAContainerDn
                                    );
        ...
        if (policy.getTrustedCAs() != null && policy.getTrustedCAs().length > 0) {
          ...
          if (trustedCADns != null && trustedCADns.size() > 0) {
            ...
            TenantTrustedCertChainLdapObject.getInstance().updateObject(
                                                                  connection,
                                                                  trustedCAsDn,
                                                                  trustedCAs
                                                              );
            ...
            // Create trusted CAs
            TenantTrustedCertChainLdapObject.getInstance().createObject(
                                                                  connection,
                                                                  trustedCAsDn,
                                                                  trustedCAs
                                                              );
        ...
        // set OCSP list
        setOCSPLists(certPolicyDn, connection, policy.get_siteOCSPList());
   ...
   */
  private void
  setOCSPLists(String certPolicyDn, ILdapConnectionEx connection, HashMap<String, AlternativeOCSPList> siteOcspMap) {
    ValidateUtil.validateNotEmpty(certPolicyDn, "certPolicyDn");

    ContainerLdapObject instContainer = ContainerLdapObject.getInstance();
    String ocspListContainerDn = DirectoryConfigStore.ensureObjectExists(
                                    connection,
                                    certPolicyDn,
                                    instContainer,
                                    ContainerLdapObject.CONTAINER_CLIENT_CERT_OCSP_LISTS,
    ...
    if (siteOcspMap != null && siteOcspMap.size() > 0) {
      ...
      if (siteOcspMap.size() != existingOcspLists.size()) {
        AlternativeOCSPListLdapObject.getInstance().deleteObject(connection, ocspListContainerDn);

        //recreate empty DN
        ocspListContainerDn = DirectoryConfigStore.ensureObjectExists(
                                  connection,
                                  certPolicyDn,
                                  instContainer,
                                  ContainerLdapObject.CONTAINER_CLIENT_CERT_OCSP_LISTS,
      ...
      //Note: this does not guarantee remove old site config if site ID is changed.
      //      But this is okay. CLI is capable to clean all sites
  ...
  private void updateOCSPList(String ocspListContainerDn, ILdapConnectionEx connection,
    ...
    String listDn = ocspListObj.getDnFromCn(ocspListContainerDn, ocspList.get_siteID());
    ...
    if (existingOcspLists == null || !existingOcspLists.contains(ocspList)) {
      ...
      if (ocspList != null) {
        ...
        ContainerLdapObject ocspContainer =
            ContainerLdapObject.getInstance();
        String ocspContainerDn =DirectoryConfigStore.ensureObjectExists(
                                    connection,
                                    listDn,
                                    ocspContainer,
                                    ContainerLdapObject.CONTAINER_OCSPs,
  ...
  public RSAAgentConfig getRSAAgentConfig(String tenantName) throws Exception {
    ...
    try (PooledLdapConnection pooledConnection = borrowConnection()) {
      ...
      Collection<RSAAgentConfig> configs = retrieveObjectsCollection(
                        connection,
                        tenantsRootDn,
                        ...
                        new IObjectProcessedCallback<RSAAgentConfig>() {
                          ...
                          public void processObjectSaved(
                            ...
                            rsaConfig.set_idsUserIDAttributeMaps(
                                retrieveRSAConfigIdsUserIDAttributeMaps(connection, rsaConfigDn)
                            );
                          }
                        }
                      );
  ...
  retrieveRSAAMInstancesMap(ILdapConnectionEx connection, String rsaAgentConfigDn) {
    ValidateUtil.validateNotEmpty(rsaAgentConfigDn, "rsaAgentConfigDn");

    Collection<RSAAMInstanceInfo> instColection = retrieveObjectsCollection(
                                                      connection,
                                                      rsaAgentConfigDn,
  ...
  private static HashMap<String, String> retrieveRSAConfigIdsUserIDAttributeMaps(ILdapConnectionEx connection,
    ...
    Collection<AttributeMapping> mapCollection = retrieveObjectsCollection(
                                                      connection,
                                                      rsaAgentConfigDn,
  ...
  public void setRsaAgentConfig(String tenantName, RSAAgentConfig rsaConfig) throws Exception {
    ...
    try (PooledLdapConnection pooledConnection = borrowConnection()) {
      ...
      String rsaConfigsContainerDn = DirectoryConfigStore.ensureObjectExists(
                                          connection,
                                          tenantsRootDn,
                                          rsaConfigsContainer,
                                          ContainerLdapObject.CONTAINER_RSA_CONFIGURATIONS,
  ...
  private void
  deleteRSAConfigUserIDAttributeMap(
      String tenantName,
      ILdapConnectionEx connection,
      String rsaConfigDn,
    ...
    try {
      ...
      if (ServerUtils.isNullOrEmpty(rsaConfigDn) == false) {
        String idsUserIDAttributeMapsDn = attrMapsLdapObject.lookupObject(
                                              connection,
                                              rsaConfigDn,
                                              LdapScope.SCOPE_ONE_LEVEL,
                                              ContainerLdapObject.CONTAINER_RSA_IDS_USERID_ATTRIBUTE_MAPS
  ...
  private static void
  saveRSAConfigUserIDAttributeMap(
      ILdapConnectionEx connection,
      String rsaConfigDn,
  ...
  setRsaInstances(
    ...
    ContainerLdapObject instContainer = ContainerLdapObject.getInstance();
    String instContainerDn = DirectoryConfigStore.ensureObjectExists(
                                  connection,
                                  rsaConfigDn,
                                  instContainer,
                                  ContainerLdapObject.CONTAINER_RSA_INSTANCES,
  ...
  public void deleteRSAInstanceInfo(String tenantName, String siteID) throws Exception {
    ...
    try (PooledLdapConnection pooledConnection = borrowConnection()) {
      ...
      // test
      Set<String> rsaInstanceDns = instContainer.lookupObjects(
                                        connection,
                                        instContainerDn,
                                        LdapScope.SCOPE_ONE_LEVEL,
                                        siteID,
                                        RSAInstanceLdapObject.OBJECT_CLASS
                                    );
  ...
  addRSAInstanceInfo(
      ...
      ILdapConnectionEx connection,
      Collection<RSAAMInstanceInfo> instances,
      RSAAMInstanceInfo inst
  ) {
    RSAInstanceLdapObject rsaInstanceLdap = RSAInstanceLdapObject.getInstance();
  ...
  private String getDefaultTenant(ILdapConnectionEx connection) {
    ...
    if (ServerUtils.isNullOrEmpty(rootSystemConfigDn) == false) {
      ...
      defaultTenant = ServerUtils.getStringValue(
          tenantsContainer.getObjectProperty(
              connection,
              rootSystemConfigDn,
              LdapScope.SCOPE_ONE_LEVEL,
  ...
  private void setDefaultTenant(ILdapConnectionEx connection, String defaultTenant) {
    ...
    tenantsContainer.setObjectPropertyValue(
        connection,
        tenantsContainer.getDnFromCn(
            rootSystemConfigDn,
            tenantsContainer.getCn(TenantsContainerLdapObject.CONTAINER_TENANTS)
        ),
        TenantsContainerLdapObject.PROPERTY_DEFAULT_TENANT,
        ServerUtils.getLdapValue(defaultTenant)
    );
  }
  ...
  private void setSystemTenant(ILdapConnectionEx connection, String systemTenant) {
    ...
    tenantsContainer.setObjectPropertyValue(
        ...
        TenantsContainerLdapObject.PROPERTY_SYSTEM_TENANT,
        ServerUtils.getLdapValue(systemTenant)
    );
  }

  private static Collection<RelyingParty>
  getRelyingParties(
      DirectoryConfigStore directoryConfigStore,
      ILdapConnectionEx connection,
      String tenantName,
    ...
    Collection<RelyingParty> relyingParties = retrieveObjectsCollection(
          connection,
          tenantsRootDn,
          ContainerLdapObject.CONTAINER_RELYING_PARTIES,
          propertyFilter,
          ...
          new IObjectProcessedCallback<RelyingParty>() {
            ...
            public void processObjectSaved(
              ...
              relyingParty.setAssertionConsumerServices(
                  retrieveRelyingPartyAssertionConsumerServices(connection, objectDn)
              );
              relyingParty.setAttributeConsumerServices(
                      retrieveRelyingPartyAttributeConsumerServices(connection, objectDn)
              );
              relyingParty.setSingleLogoutServices(
                      retrieveRelyingPartySingleLogoutServices(connection, objectDn)
              );
              relyingParty.setSignatureAlgorithms(
                      retrieveRelyingPartySignatureAlgorithms(connection,objectDn)
              );
            }
          }
        );
  ...
  private IIdentityStoreData getLocalOsDomainIdentityStoreData(IIdentityStoreData idsData) {
    ServerIdentityStoreData serverIdentityStoreData = new ServerIdentityStoreData(
                                                              idsData.getDomainType(),
                                                              idsData.getName()
                                                          );
  ...
  SaveIdentityProviderConfig(
    ...
    if (ServerUtils.isNullOrEmpty(aliasName) == false) {
      ...
      try {
        existingObject = identityProviderConfigObject.lookupObject(
                              connection,
                              identityProvidersContainerDn,
                              LdapScope.SCOPE_ONE_LEVEL,
                              aliasName
  ...
  private static void
  saveIdentityProviderAttributesMap(
      ILdapConnectionEx connection,
  ...
  retrieveIdentityProviderAttributesMap(ILdapConnectionEx connection, String identityProviderDn) {
  ...
  private static void
  saveIdentityProviderSchemaMapping(
      ILdapConnectionEx connection,
      String identityProviderDn,
  ...
  private static IdentityStoreSchemaMapping
  retrieveIdentityStoreSchemaMapping(ILdapConnectionEx connection, String identityProviderDn) {
    Collection<AttributeMapping> mappings = retrieveObjectsCollection(
                                                connection,
                                                identityProviderDn,
  ...
  private static void retrieveIdentityProviderSchemaMapping(ILdapConnectionEx connection, String identityProviderDn,
    ...
    if (provider instanceof ServerIdentityStoreData) {
      ServerIdentityStoreData storeData = (ServerIdentityStoreData) provider;
      if ((storeData.getDomainType() == DomainType.EXTERNAL_DOMAIN) || (getInternalInfo == true)) {
        IdentityStoreSchemaMapping schemaMapping = retrieveIdentityStoreSchemaMapping(
                                                        connection,
                                                        identityProviderDn
                                                    );
  ...
  private static void
  saveRelyingPartyAssertionConsumerServices(
      ILdapConnectionEx connection,
    ...
    saveObjectsCollection(
        ...
        AssertionConsumerServiceLdapObject.getInstance(),
        services,
        null
    );
  }

  private static Collection<AssertionConsumerService>
  retrieveRelyingPartyAssertionConsumerServices(ILdapConnectionEx connection, String relyingPartyDn) {
    return retrieveObjectsCollection(
        connection,
        relyingPartyDn,
        ContainerLdapObject.CONTAINER_ASSERTION_COMSUMER_SERVICES,
        AssertionConsumerServiceLdapObject.getInstance(),
  ...
  private static void
  saveRelyingPartyAttributeConsumerServices(
      ILdapConnectionEx connection,
      String relyingPartyDn,
  ...
  private static Collection<AttributeConsumerService>
  retrieveRelyingPartyAttributeConsumerServices(ILdapConnectionEx connection, String relyingPartyDn) {
    return retrieveObjectsCollection(
              connection,
              relyingPartyDn,
              ContainerLdapObject.CONTAINER_ATTRIBUTE_COMSUMER_SERVICES,
  ...
  private static void
  saveRelyingPartySingleLogoutServices(
      ILdapConnectionEx connection,
      String relyingPartyDn,
  ...
  private static Collection<ServiceEndpoint>
  retrieveRelyingPartySingleLogoutServices(ILdapConnectionEx connection, String relyingPartyDn) {
    return retrieveObjectsCollection(
        connection,
        relyingPartyDn,
        ContainerLdapObject.CONTAINER_SINGLE_LOGOUT_SERVICES,
  ...
  private static void
  saveRelyingPartySignatureAlgorithms(
      ILdapConnectionEx connection,
      String relyingPartyDn,
      Collection<SignatureAlgorithm> algorithms
  ) {
    saveIndexWrappedObjectsCollecton(
        connection,
        relyingPartyDn,
        ContainerLdapObject.CONTAINER_SIGNATURE_ALGORITHMS_SERVICES,
        SignatureAlgorithmsLdapObject.getInstance(),
        algorithms,
        null
    );
  }

  private static Collection<SignatureAlgorithm>
  retrieveRelyingPartySignatureAlgorithms(ILdapConnectionEx connection, String relyingPartyDn) {
  ...
  private static void saveAttributes(ILdapConnectionEx connection, String parentDn, Collection<Attribute> attributes) {
    saveIndexWrappedObjectsCollecton(
        ...
        TenantAttributeLdapObject.getInstance(),
        attributes,
        null
    );
  }
  ...
  saveObjectsCollection(
      ...
      String parentDn,
      String containerCn,
      ILdapObject<T> iLdapObject,
      Collection<T> objects,
      IObjectProcessedCallback<T> callback
  ) {
    ContainerLdapObject containerConfigObject = ContainerLdapObject.getInstance();

    String containerDn = containerConfigObject.lookupObject(
                              connection,
                              parentDn,
                              LdapScope.SCOPE_ONE_LEVEL,
                              containerCn
  ...
  retrieveIndexWrappedObjectsCollection(
      ILdapConnectionEx connection,
      String parentDn,
      String containerCn,
      ILdapObject<IndexedObjectWrapper<T>> iLdapObject,
  ...
  retrieveObjectsCollection(
    ...
    if (ServerUtils.isNullOrEmpty(containerDn) == false) {
      List<T> objectsCollection = iLdapObject.searchObjects(
                                      connection,
                                      containerDn,
                                      LdapScope.SCOPE_ONE_LEVEL,
                                      additionalFilter
  ...
  createSystemDomainIdentityProviderForTenant(
    ...
    try {
      ...
      DirectoryConfigStore.SaveIdentityProviderConfig(
          this,
          connection,
          tenantsRootDn,
  ...
  private static LdapValue[]
  getTenantProperty(ILdapConnectionEx connection, String tenantsRootDn, String propertyName) throws Exception {
    return TenantLdapObject.getInstance().getObjectProperty(
                connection,
                tenantsRootDn,
                LdapScope.SCOPE_BASE,
                null,
  ...
  private String lookupTenantsRootDn(ILdapConnectionEx connection, String tenantName) {
    ...
    if (ServerUtils.isNullOrEmpty(rootSystemConfigDn) == false) {
      ...
      String tenantsContainerDn = tenantsConfigObject.lookupObject(
                                      connection,
                                      rootSystemConfigDn,
                                      LdapScope.SCOPE_ONE_LEVEL,
                                      tenantsConfigObject.getCn(TenantsContainerLdapObject.CONTAINER_TENANTS)
                                  );
      if (ServerUtils.isNullOrEmpty(tenantsContainerDn) == false) {
        TenantLdapObject tenantConfig = TenantLdapObject.getInstance();
        tenantsRootDn = tenantConfig.lookupObject(
                            connection,
                            tenantsContainerDn,
                            LdapScope.SCOPE_ONE_LEVEL,
                            tenantName
  ...
  private String getRootSystemConfigDn(ILdapConnectionEx connection, boolean createIfNotExists) {
    ...
    String servicesDn = DirectoryConfigStore.ensureObjectExists(
                            connection,
                            this.getRootDn(),
    ...
    if (ServerUtils.isNullOrEmpty(servicesDn) == false) {
      identityManagerDn = DirectoryConfigStore.ensureObjectExists(
                              connection,
                              servicesDn,
                              containerConfigObject,
  ...
  ensureObjectExists(
    ...
    String objectDn = iLdapObject.lookupObject(
                          connection,
                          parentDn,
                          LdapScope.SCOPE_ONE_LEVEL,
