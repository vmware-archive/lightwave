...
public class PooledLdapConnectionIdentity {
    ...
    private PooledLdapConnectionIdentity(String tenantName, String connectionString, String username, String password,
	    AuthenticationType authType, boolean useGCPort, int priority, Collection<X509Certificate> idsTrustedCertificates,
	...
	public PooledLdapConnectionIdentity build() {
	    return new PooledLdapConnectionIdentity(tenantName, connectionString, username, password, authType,
		    useGCPort, priority, idsTrustedCertificates, tenantTrustedCertificates);
	}
