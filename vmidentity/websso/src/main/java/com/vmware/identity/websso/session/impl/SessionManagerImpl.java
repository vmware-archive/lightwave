 ...
 *  under the License.
 */
package com.vmware.identity.websso.session.impl;
...
import com.vmware.identity.websso.session.SessionParticipant;
...
public class SessionManagerImpl implements SessionManager {
     ...
     *
     * @see
     * com.vmware.identity.websso.session.SessionManager#add(com.vmware.identity.websso.session
     * .Session)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.vmware.identity.websso.session.SessionManager#getAll()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.vmware.identity.websso.session.SessionManager#get(java.lang.String)
     */
    @Override
     ...
     *
     * @see
     * com.vmware.identity.websso.session.SessionManager#getByParticipant(java.lang
     * .String)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.vmware.identity.websso.session.SessionManager#remove(java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.vmware.identity.websso.session.SessionManager#removeAll()
     */
    @Override
    public void clear() {
