...
package com.vmware.identity.websso.proxyservice;
...
import com.vmware.identity.websso.samlservice.AuthnRequestState;
import com.vmware.identity.websso.samlservice.DefaultIdmAccessorFactory;
import com.vmware.identity.websso.samlservice.IdmAccessor;
import com.vmware.identity.websso.samlservice.OasisNames;
import com.vmware.identity.websso.samlservice.SAMLResponseSender;
import com.vmware.identity.websso.samlservice.SAMLResponseSenderFactory;
import com.vmware.identity.websso.samlservice.SamlServiceException;
import com.vmware.identity.websso.samlservice.Shared;
import com.vmware.identity.websso.samlservice.SamlValidator.ValidationResult;
import com.vmware.identity.websso.samlservice.impl.ConfigExtractorFactoryImpl;
import com.vmware.identity.websso.samlservice.impl.SAMLAuthnResponseSenderFactory;
import com.vmware.identity.websso.samlservice.impl.SamlServiceImpl;
import com.vmware.identity.websso.session.Session;
import com.vmware.identity.websso.session.SessionManager;
...
public class LogonProcessorImpl implements LogonProcessorEx {
     ...
     *
     * @see
     * com.vmware.identity.websso.websso.client.LogonProcessor#authenticationError(
     * com.vmware.identity.websso.websso.client.Message,
     ...
     *
     * @see
     * com.vmware.identity.websso.websso.client.LogonProcessor#authenticationSuccess
     * (com.vmware.identity.websso.websso.client.Message,
     * javax.servlet.http.HttpServletResponse)
     *
     ...
     *
     * @see
     * com.vmware.identity.websso.websso.client.LogonProcessor#internalError(java.lang
