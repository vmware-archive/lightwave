...
package com.vmware.identity.websso.samlservice.impl;
...
import com.vmware.identity.websso.samlservice.DefaultSamlServiceFactory;
...
import com.vmware.identity.websso.samlservice.SamlService;
import com.vmware.identity.websso.samlservice.SamlServiceFactory;
...
import com.vmware.identity.websso.samlservice.impl.AuthnRequestStateKerbAuthenticationFilter.KerbAuthnType;
...
public class SAMLAuthnResponseSender implements SAMLResponseSender {
     ...
     */
    /* (non-Javadoc)
     * @see com.vmware.identity.websso.samlservice.SAMLResponseSender#sendResponseToSP(java.lang.String, org.w3c.dom.Document)
     */
    @Override
