...
import com.vmware.identity.websso.samlservice.RequestCache;
...
public class RequestCacheImpl extends LinkedHashMap<String, Integer> implements RequestCache {
	...
	/* (non-Javadoc)
	 * @see com.vmware.identity.websso.samlservice.RequestCache#shouldDenyRequest(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.vmware.identity.websso.samlservice.RequestCache#storeRequest(java.lang.String)
	 */
