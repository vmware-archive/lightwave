...
import com.vmware.identity.websso.samlservice.LogoutState;
import com.vmware.identity.websso.samlservice.OasisNames;
import com.vmware.identity.websso.samlservice.Shared;
import com.vmware.identity.websso.samlservice.LogoutState.ProcessingState;
...
public class LogoutProcessorImpl implements LogoutProcessor {
     ...
     * IDP.
     *
     * @see com.vmware.identity.websso.websso.client.LogoutProcessor#logoutError(com.vmware.identity.websso.websso.client.Message,
     ...
     *
     * @see
     * com.vmware.identity.websso.websso.client.LogoutProcessor#internalError(java.
