...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
 <head>
  ...
  <script type="text/javascript" src="./resources/locale/en/welcomeRes.js"> </script>
  <script type="text/javascript" src="./resources/js/setUserLocale.js"> </script>

  <script type="text/javascript">document.write("<title>" + ID_WelcomePsc + "</title>");</script>
