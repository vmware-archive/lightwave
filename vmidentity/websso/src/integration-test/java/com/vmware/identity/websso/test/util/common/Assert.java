...
public class Assert {
   ...
   */
  public static void assertTrue(
    boolean expression, String message, String errorMessage
  ) throws AssertException {
   ...
   *
   * @param expression   an expression to be checked whether it is false or
   *                     not
   ...
   * @throws AssertException when the object is null after logging of the
   *                         error
   *                         message
   */
  public static void assertNotNull(
    Object notNullObject, String errorMessage
  ) throws AssertException {
   ...
   */
  public static void assertNotNull(
    Object notNullObject, String message, String errorMessage
  ) throws AssertException {
  ...
  public static void assertNull(
    Object nullObject, String errorMessage
  ) throws AssertException {
   ...
   */
  public static void assertNull(
    Object nullObject, String message, String errorMessage
  ) throws AssertException {
  ...
  public static void assertNotEmpty(
    Collection<?> col, String errorMessage
  ) throws AssertException {
    assertNotNull(col, errorMessage); assertFalse(col.isEmpty(), errorMessage);
  }
   ...
   *
   * @param col          Any Collection object
   * @param message      a message to be logged if the Collection is not
   *                     empty.
   * @param errorMessage a message to be logged if the Collection is empty.
   * @throws AssertException when the Collection is empty after logging the
   *                         error message
   */
  public static void assertNotEmpty(
    Collection<?> col, String message, String errorMessage
  ) throws AssertException {
    assertNotEmpty(col, errorMessage); if (message != null) {
      log.info(message);
    }
  }
   ...
   */
  public static void assertNotEmpty(
    Object[] arr, String errorMessage
  ) throws AssertException {
    assertNotNull(arr, errorMessage); assertTrue(arr.length > 0, errorMessage);
  }
   ...
   */
  public static void assertNotEmpty(
    Object[] arr, String message, String errorMessage
  ) throws AssertException {
    assertNotEmpty(arr, errorMessage); if (message != null) {
      log.info(message);
    }
  }
  ...
  private static void assertBoolean(
    ...
    if (expression) {
      ...
      log.error(errorMessage == null ? "Assertion failed" : errorMessage); throw new AssertException(errorMessage);
    }
  }
}
