...
IdmCertificateGetTest()
{
    ...
    e = IdmCertificateGet(pBearerTokenClient, tenant, certificateScopeType, &pCertificateChainArrayReturn, &pServerError);
    BAIL_ON_ERROR(e);
...
IdmCertificateDeleteTest()
{
    ...
    e = IdmCertificateDelete(pBearerTokenClient, tenant, fingerprint, &pServerError);
    BAIL_ON_ERROR(e);
...
IdmCertificateGetPrivateKeyTest()
{
    ...
    e = IdmCertificateGetPrivateKey(pBearerTokenClient, tenant, &pPrivateKeyReturn, &pServerError);
    BAIL_ON_ERROR(e);
...
IdmCertificateSetCredentialsTest()
{
    ...
    e = IdmCertificateSetCredentials(pBearerTokenClient, tenant, pTenantCredentials, &pServerError);
    BAIL_ON_ERROR(e);
