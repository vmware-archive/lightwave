...
static PCSTRING name = "test_relying_party_name";
static PSTRING url = "http://abc.com/relyingParty";
...
IdmRelyingPartyRegisterTest()
{
    ...
    e = IdmRelyingPartyRegister(pBearerTokenClient, tenant, pRelyingParty, &pRelyingPartyReturn, &pServerError);
    BAIL_ON_ERROR(e);
...
IdmRelyingPartyGetAllTest()
{
    ...
    e = IdmRelyingPartyGetAll(pBearerTokenClient, tenant, &pRelyingPartyArrayReturn, &pServerError);
    BAIL_ON_ERROR(e);
...
IdmRelyingPartyGetTest()
{
    ...
    e = IdmRelyingPartyGet(pBearerTokenClient, tenant, name, &pRelyingPartyReturn, &pServerError);
    BAIL_ON_ERROR(e);
...
IdmRelyingPartyUpdateTest()
{
    ...
    e = IdmRelyingPartyUpdate(pBearerTokenClient, tenant, name, pRelyingParty, &pRelyingPartyReturn, &pServerError);
    BAIL_ON_ERROR(e);
...
IdmRelyingPartyDeleteTest()
{
    ...
    e = IdmRelyingPartyDelete(pBearerTokenClient, tenant, name, &pServerError);
    BAIL_ON_ERROR(e);
