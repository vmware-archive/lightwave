...
IdmTenantCreateTest()
{
    ...
    // create tenant
    e = IdmTenantDataNew(&pTenant, tenant, longName, key, guid, issuer, pTenantCredentials, username, password);
    BAIL_ON_ERROR(e);

    e = IdmTenantCreate(pBearerTokenClient, pTenant, &pTenantReturn, &pServerError);
    BAIL_ON_ERROR(e);
...
IdmTenantGetTest()
{
    ...
    e = IdmTenantGet(pBearerTokenClient, tenant, &pTenantReturn, &pServerError);
    BAIL_ON_ERROR(e);
...
IdmTenantDeleteTest()
{
    ...
    e = IdmTenantDelete(pBearerTokenClient, tenant, &pServerError);
    BAIL_ON_ERROR(e);
...
IdmTenantGetConfigTest()
{
    ...
    e = IdmTenantGetConfig(pBearerTokenClient, tenant, &tenantConfigTypes, &pTenantConfigurationReturn, &pServerError);
    BAIL_ON_ERROR(e);
...
IdmTenantUpdateConfigTest()
{
    ...
    e = IdmTenantUpdateConfig(pBearerTokenClient, tenant, pTenantConfiguration, &pTenantConfigurationReturn, &pServerError);
    BAIL_ON_ERROR(e);
...
IdmTenantSearchTest()
{
    ...
    IdmTenantSearch(pBearerTokenClient, tenant, domain, query, memberType, searchBy, limit, &pSearchResultReturn, &pServerError);
    BAIL_ON_ERROR(e);
