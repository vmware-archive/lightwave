...
static PCSTRING provider = "test_name";
...
IdmIdentityProviderCreateTest()
{
    ...
    PSTRING pConnectionStringArray[] =
    {
        "ldap://10.160.240.69:389"
    };
    ...
    e = IdmIdentityProviderCreate(pBearerTokenClient, tenant, pIdentityProvider, &pIdentityProviderReturn, &pServerError);
    BAIL_ON_ERROR(e);
...
IdmIdentityProviderProbeTest()
{
    ...
    e = IdmIdentityProviderProbe(pBearerTokenClient, tenant, pIdentityProvider, &pServerError);
    BAIL_ON_ERROR(e);
...
IdmIdentityProviderGetAllTest()
{
    ...
    e = IdmIdentityProviderGetAll(pBearerTokenClient, tenant, &pIdentityProviderArrayReturn, &pServerError);
    BAIL_ON_ERROR(e);
...
IdmIdentityProviderGetTest()
{
    ...
    e = IdmIdentityProviderGet(pBearerTokenClient, tenant, provider, &pIdentityProviderReturn, &pServerError);
    BAIL_ON_ERROR(e);
...
IdmIdentityProviderUpdateTest()
{
    ...
    e = IdmIdentityProviderUpdate(pBearerTokenClient, tenant, provider, pIdentityProvider, &pIdentityProviderReturn, &pServerError);
    BAIL_ON_ERROR(e);
...
IdmIdentityProviderDeleteTest()
{
    ...
    e = IdmIdentityProviderDelete(pBearerTokenClient, tenant, provider, &pServerError);
    BAIL_ON_ERROR(e);
