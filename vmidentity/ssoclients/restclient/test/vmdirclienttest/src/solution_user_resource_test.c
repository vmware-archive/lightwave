...
VmdirSolutionUserCreateTest()
{
    ...
    e = VmdirSolutionUserCreate(pBearerTokenClient, tenant, pSolutionUser, &pSolutionUserReturn, &pServerError);
    BAIL_ON_ERROR(e);
...
VmdirSolutionUserGetTest()
{
    ...
    e = VmdirSolutionUserGet(pBearerTokenClient, tenant, name, &pSolutionUserReturn, &pServerError);
    BAIL_ON_ERROR(e);
...
VmdirSolutionUserUpdateTest()
{
    ...
    PSTRING domain = "test_tenant_name";
    PSTRING description = "description";
    ...
    e = VmdirSolutionUserUpdate(pBearerTokenClient, tenant, name, pSolutionUser, &pSolutionUserReturn, &pServerError);
    BAIL_ON_ERROR(e);
...
VmdirSolutionUserDeleteTest()
{
    ...
    e = VmdirSolutionUserDelete(pBearerTokenClient, tenant, name, &pServerError);
    BAIL_ON_ERROR(e);
