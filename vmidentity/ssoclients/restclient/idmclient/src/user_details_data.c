    ...
    PCSTRING description)
{
    ...
    IDM_USER_DETAILS_DATA* pUserDetails = NULL;
    ...
    e = SSOMemoryAllocate(sizeof(IDM_USER_DETAILS_DATA), (void**) &pUserDetails);
    BAIL_ON_ERROR(e);
    ...
    *ppUserDetails = pUserDetails;
    ...
    if (e != SSOERROR_NONE)
    {
        IdmUserDetailsDataDelete(pUserDetails);
    }
    ...
    IDM_USER_DETAILS_DATA* pUserDetails)
{
    if (pUserDetails != NULL)
    {
        ...
        SSOMemoryFree(pUserDetails, sizeof(IDM_USER_DETAILS_DATA));
    }
}
