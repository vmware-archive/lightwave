    ...
    const SSO_LONG* lifetime)
{
    ...
    IDM_PASSWORD_DETAILS_DATA* pPasswordDetails = NULL;
    ...
    e = SSOMemoryAllocate(sizeof(IDM_PASSWORD_DETAILS_DATA), (void**) &pPasswordDetails);
    BAIL_ON_ERROR(e);
    ...
    *ppPasswordDetails = pPasswordDetails;
    ...
    if (e != SSOERROR_NONE)
    {
        IdmPasswordDetailsDataDelete(pPasswordDetails);
    }
    ...
    IDM_PASSWORD_DETAILS_DATA* pPasswordDetails)
{
    if (pPasswordDetails != NULL)
    {
        ...
        SSOMemoryFree(pPasswordDetails, sizeof(IDM_PASSWORD_DETAILS_DATA));
    }
}
