 ...
 *  under the License.
 */
package com.vmware.directory.rest.server.test.integration.util;

import com.vmware.directory.rest.server.test.integration.datagenerator.CertificateDataGenerator;
