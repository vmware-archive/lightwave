...
public class ADProviderResourceIT {
    ...
    @Test
    public void testGetStatus() throws ClientProtocolException, HttpException, ClientException, IOException {
        ActiveDirectoryJoinInfoDTO status = client.activeDirectory().getStatus();
