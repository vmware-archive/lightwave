...
/**
 * Validate token after deleting the local user
 */
@RunWith(Parameterized.class)
public class ValidateTokenAfterUserDeletionIT extends WSTrustTestBase {
  protected static final Logger logger = LoggerFactory.getLogger(ValidateTokenAfterUserDeletionIT.class);
  ...
  public void test() throws Exception {
    ...
    logger.info("Delete the local user and group");
  ...
  private TokenSpec createTokenSpec(boolean isRenewable, List<Advice> advices, Set<String> audienceRestriction) {
    TokenSpec.Builder specBuilder = new TokenSpec.Builder(
        600);
    if (advices != null) {
  ...
  private static class TestParam {
    ...
    public TestParam(MethodEnum methodEnum, boolean isRenewable,
