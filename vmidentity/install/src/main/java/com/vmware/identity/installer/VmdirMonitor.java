...
public class VmdirMonitor {
    ...
    public static void main(String args[]) 
    {
        ...
        try {
            /**
             * MONITOR IDM PROCESS - TOP COMMAND
             */
            System.out.println("Starting monitoring : VMDIR process");
            String[] cmd = {
                    "/bin/sh",
                    "-c",
                    "ps -ef | grep vmdird | grep -v grep | awk '{print $2}'"
            ...
            System.out.println("VMDIR PROCESS : " + biggestProcessId);
