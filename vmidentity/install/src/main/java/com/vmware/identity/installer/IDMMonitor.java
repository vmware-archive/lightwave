...
public class IDMMonitor {
    ...
    public static void main(String args[]) 
    {
        ...
        try {
             ...
             */
            System.out.println("Starting monitoring : IDM process");
            String[] cmd = {
                    "/bin/sh",
                    "-c",
                    "ps -ef | grep idmd | grep -v grep | awk '{print $2}'"
            ...
            System.out.println("IDM PROCESS : " + biggestProcessId);
