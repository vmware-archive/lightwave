...
#define LWCA_INVALID_TIME_SPECIFIED         (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 6)
#define LWCA_KEY_CREATION_FAILURE           (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 7)
#define LWCA_CERT_DECODE_FAILURE            (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 8)
#define LWCA_KEY_IO_FAILURE                 (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 9)
#define LWCA_CERT_IO_FAILURE                (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 10)
#define LWCA_NOT_CA_CERT                    (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 11)
#define LWCA_INVALID_CSR_FIELD              (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 12)
#define LWCA_SELF_SIGNATURE_FAILED          (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 13)
#define LWCA_INIT_CA_FAILED                 (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 14)
#define LWCA_ERROR_INVALID_KEY_LENGTH       (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 15)
#define LWCA_PKCS12_CREAT_FAIL              (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 16)
#define LWCA_PKCS12_IO_FAIL                 (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 17)
#define LWCA_CRL_ERROR                      (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 18)
#define LWCA_NO_NEW_CRL                     (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 19)
#define LWCA_ERROR_READING_CRL              (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 20)
#define LWCA_CRL_LOCAL_ERROR                (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 21)
#define LWCA_SSL_ADD_EXTENSION              (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 22)
#define LWCA_SSL_REQ_SIGN_ERR               (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 23)
#define LWCA_SSL_RAND_ERR                   (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 24)
#define LWCA_SSL_CERT_SIGN_ERR              (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 25)
#define LWCA_SSL_TIME_ERROR                 (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 26)
#define LWCA_SSL_EXT_ERR                    (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 27)
#define LWCA_SSL_SIGN_FAIL                  (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 28)
#define LWCA_SSL_SET_ISSUER_NAME            (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 29)
#define LWCA_SSL_SET_START_TIME             (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 30)
#define LWCA_SSL_SET_END_TIME               (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 31)
#define LWCA_SSL_SET_EXT_ERR                (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 32)
#define LWCA_CERT_PRIVATE_KEY_MISMATCH      (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 33)
#define LWCA_INVALID_DOMAIN_NAME            (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 34)
#define LWCA_CRL_SET_SERIAL_FAIL            (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 35)
#define LWCA_CRL_SET_TIME_FAIL              (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 36)
#define LWCA_CRL_CERT_ALREADY_REVOKED       (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 37)
#define LWCA_CRLNUMBER_READ_ERROR           (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 38)
#define LWCA_CRL_SIGN_FAIL                  (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 39)
#define LWCA_CRL_REASON_FAIL                (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 40)
#define LWCA_CRL_SORT_FAILED                (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 41)
#define LWCA_CRL_NULL_TIME                  (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 42)
#define LWCA_CRL_DECODE_ERROR               (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 43)
#define LWCA_VPX_RSUTIL_ERROR               (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 44)
#define LWCA_ERROR_INVALID_SN               (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 45)
#define LWCA_ERROR_INVALID_SAN              (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 46)
#define LWCA_ERROR_INVALID_CERTIFICATE      (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 47)
#define LWCA_ERROR_INCOMPLETE_CHAIN         (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 48)
#define LWCA_ERROR_INVALID_CHAIN            (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 49)
#define LWCA_ERROR_CANNOT_FORM_REQUEST      (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 50)
#define LWCA_KEY_DECODE_FAILURE             (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 51)
#define LWCA_ERROR_CN_HOSTNAME_MISMATCH     (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 52)
#define LWCA_ERROR_SAN_HOSTNAME_MISMATCH    (LWCA_ERROR_BASE + LWCA_SSL_ERROR_BASE + 53)
