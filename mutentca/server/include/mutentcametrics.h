...
typedef enum
{
    LWCA_METRICS_DB_ADD_CA = 0,
    LWCA_METRICS_DB_GET_CA,
    LWCA_METRICS_DB_UPDATE_CA,
    LWCA_METRICS_DB_LOCK_CA,
    LWCA_METRICS_DB_UNLOCK_CA,
    LWCA_METRICS_DB_ADD_CA_CERT,
    LWCA_METRICS_DB_GET_CA_CERT,
    LWCA_METRICS_DB_GET_CA_CERTS,
    LWCA_METRICS_DB_UPDATE_CA_CERT,
    LWCA_METRICS_DB_LOCK_CA_CERT,
    LWCA_METRICS_DB_UNLOCK_CA_CERT,
    LWCA_METRICS_DB_ADD_CERT,
    LWCA_METRICS_DB_GET_CERT,
    LWCA_METRICS_DB_GET_CERTS,
    LWCA_METRICS_DB_GET_REVOKED_CERTS,
    LWCA_METRICS_DB_UPDATE_CERT,
    LWCA_METRICS_DB_LOCK_CERT,
    LWCA_METRICS_DB_UNLOCK_CERT,
    LWCA_METRICS_DB_COUNT
} LWCA_METRICS_DB_APIS;
