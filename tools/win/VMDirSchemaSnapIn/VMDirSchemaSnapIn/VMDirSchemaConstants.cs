...
namespace VMDirSchemaSnapIn
{
    public static class VMDirSchemaConstants
    {
        ...
        public const string TOOLNAME = "VMDir Schema Management";
        public const string TOOLDESCRIPTION = "VMDir Schema Management tool to adminster schema and compare federation nodes";
        ...
        public const string WELCOME_DESCRIPTION3 = "Administer Federation Schema";
        ...
        public const string TIME_OUT = "Server Connection timed out. Please verify the login details";
        ...
        public const string COMPARE_SCHEMA = "Compare Schema/MetaData";
