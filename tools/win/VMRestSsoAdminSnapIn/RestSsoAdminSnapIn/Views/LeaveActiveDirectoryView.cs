...
{
    public partial class LeaveActiveDirectoryView : Form, IView
    {
        ...
        public CredentialsDto ViewToDto()
        {
        ...
        {
            txtName.Text = _adJoinInfoDto.Name;
            txtAlias.Text = _adJoinInfoDto.Alias;
            txtDomain.Text = _adJoinInfoDto.Dn;
            txtStatus.Text = _adJoinInfoDto.JoinStatus;
        }
