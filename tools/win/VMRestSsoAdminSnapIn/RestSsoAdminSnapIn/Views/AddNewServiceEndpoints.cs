...
{
    public partial class AddNewServiceEndpoints : Form,IView
    {
        private ServiceEndpointDto _serviceDto;
        public AddNewServiceEndpoints()
        {
            InitializeComponent();
        }
        ...
        {            
            ...
            _serviceDto = new ServiceEndpointDto{Name = txtName.Text, Endpoint = txtEndpoint.Text, Binding = txtBinding.Text};
