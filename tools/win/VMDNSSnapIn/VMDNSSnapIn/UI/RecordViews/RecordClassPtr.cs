...
{
    class RecordClassPtr : RecordClassBase
    {
        ...
        {
            AddRecordFrm.PTRRecordHostNameText.Enabled = state;
            AddRecordFrm.PTRRecordIPAddressText.Enabled = state;
        }

        protected override void DoValidateControls()
        {
            if (string.IsNullOrWhiteSpace(AddRecordFrm.PTRRecordIPAddressText.Text) || string.IsNullOrWhiteSpace(AddRecordFrm.PTRRecordHostNameText.Text))
