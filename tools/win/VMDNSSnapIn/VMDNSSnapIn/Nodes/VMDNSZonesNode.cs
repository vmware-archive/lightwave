...
{
    class VMDNSZonesNode :VMDNSZonesBaseNode
    {
        internal VMDNSZonesNode(VMDNSServerNode node) : base(node)
        {
            DisplayName = VMDNSConstants.ZONES;
            ZoneType = -1;
            this.ImageIndex = this.SelectedImageIndex = (int)VMDNSTreeImageIndex.Zones;
            FillChildZones();
        }
