...
{
	[Register ("SplitCustomViewController")]
	partial class SplitCustomViewController
	{
		[Outlet]
		public AppKit.NSView DetailView { get; set; }

		[Outlet]
		AppKit.NSSplitView PnlSplitView { get; set; }

		[Outlet]
		AppKit.NSProgressIndicator ProgressIndicator { get; set; }

		[Outlet]
		AppKit.NSTextField RefreshTextField { get; set; }

		[Outlet]
		public AppKit.NSOutlineView TreeView { get; set; }
