...
{
	public class ServerCertificatesNode : ScopeNode
	{
		public ServerCertificatesNode (ServerDto serverDto, string tenantName)
		{
			DisplayName = "Server Certificates";
			this.Children.Add (new TrustedCertificateNode (){ Parent = this });
