...
namespace VMDNS
{
    [Register("FilterRecordsController")]
    partial class FilterRecordsController
    {
        [Outlet]
        AppKit.NSTextField RecordNameField { get; set; }

        [Outlet]
        AppKit.NSPopUpButton RecordTypeOptionsField { get; set; }

        [Outlet]
        AppKit.NSTextField ZoneNameField { get; set; }
