			...
			MaintainSession(delegate ()
				{
					//ToDo
					/*
                     * dummy GOVERNS_ID need to replaced with actual ID.
                     */
					...
					objectclass.Add(new LdapMod((int)LdapMod.mod_ops.LDAP_MOD_ADD, VMDirConstants.GOVERNS_ID, new string[] { "dummy", null }));
