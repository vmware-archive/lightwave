...
#ifdef _WIN32
    // TODO: pgu change the gLogFileName when we do implement service log on Windows.
    CHAR gLogFileName[] = "C:\\Windows\\Temp\\vmdnslog.txt";
#else
    void *gLogFileName = NULL;
#endif
