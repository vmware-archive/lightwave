...
#define VMDNS_TIME_MINUTE_IN_SECS (60)
#define VMDNS_TIME_HOUR_IN_SECS (VMDNS_TIME_MINUTE_IN_SECS *  60)
#define VMDNS_TIME_DAY_IN_SECS (VMDNS_TIME_HOUR_IN_SECS * 24)
