/*
 * Copyright (c) VmSockWinare Inc.  All rights Reserved.
 */
#include "includes.h"
    ...
    )
{
    ...
    VMDNS_LOG_DEBUG("Freeing Io Buffer - Address: %p, Event: %d, Size: %d", (DWORD)pIoBuffer, pIoContext->eventType, pIoBuffer->dwCurrentSize);
