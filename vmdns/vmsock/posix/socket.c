            ...
            else if (pEventSocket->type == VM_SOCK_TYPE_SIGNAL)
            {
                ...
                else
                {
                         ...
                         pLink = pLink->Blink)
                    {
                        ...
                        RemoveEntryList(&pSocket->ActiveSockets);
