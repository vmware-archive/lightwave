    ...
    PCSTRING description)
{
    ...
    IDM_GROUP_DETAILS_DATA* pGroupDetails = NULL;
    ...
    e = SSOMemoryAllocate(sizeof(IDM_GROUP_DETAILS_DATA), (void**) &pGroupDetails);
    BAIL_ON_ERROR(e);
    ...
    *ppGroupDetails = pGroupDetails;
    ...
    if (e != SSOERROR_NONE)
    {
        IdmGroupDetailsDataDelete(pGroupDetails);
    }
    ...
    IDM_GROUP_DETAILS_DATA* pGroupDetails)
{
    if (pGroupDetails != NULL)
    {
        ...
        SSOMemoryFree(pGroupDetails, sizeof(IDM_GROUP_DETAILS_DATA));
    }
}
