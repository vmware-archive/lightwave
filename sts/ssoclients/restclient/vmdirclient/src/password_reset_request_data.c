    ...
    PCSTRING newPassword)
{
    ...
    e = SSOMemoryAllocate(sizeof(VMDIR_PASSWORD_RESET_REQUEST_DATA), (void**) &pPasswordResetRequest);
    BAIL_ON_ERROR(e);
    ...
    VMDIR_PASSWORD_RESET_REQUEST_DATA* pPasswordResetRequest)
{
    if (pPasswordResetRequest != NULL)
    {
        ...
        SSOMemoryFree(pPasswordResetRequest, sizeof(VMDIR_PASSWORD_RESET_REQUEST_DATA));
    }
}
