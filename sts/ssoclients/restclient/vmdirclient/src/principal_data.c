    ...
    PCSTRING domain)
{
    ...
    VMDIR_PRINCIPAL_DATA* pPrincipal = NULL;
    ...
    e = SSOMemoryAllocate(sizeof(VMDIR_PRINCIPAL_DATA), (void**) &pPrincipal);
    BAIL_ON_ERROR(e);
    ...
    *ppPrincipal = pPrincipal;
    ...
    if (e != SSOERROR_NONE)
    {
        VmdirPrincipalDataDelete(pPrincipal);
    }
    ...
    VMDIR_PRINCIPAL_DATA* pPrincipal)
{
    if (pPrincipal != NULL)
    {
        ...
        SSOMemoryFree(pPrincipal, sizeof(VMDIR_PRINCIPAL_DATA));
    }
}
