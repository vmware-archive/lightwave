...
4.  As part of a successful build, the following RPMs should be created in the
    ...
    19. vmware-sts-6.7.0-0.x86\_64.rpm

    20. vmware-sts-client-6.7.0-0.x86\_64.rpm
...
1.  vmware-directory-client-6.7.0-0.x86\_64.rpm

2.  vmware-directory-6.7.0-0.x86\_64.rpm

3.  vmware-dns-client-6.7.0-0.x86\_64.rpm

4.  vmware-dns-6.7.0-0.x86\_64.rpm

5.  vmware-afd-client-6.6.2-0.x86\_64.rpm

6.  vmware-afd-6.7.0-0.x86\_64.rpm

7.  vmware-ca-client-6.7.0-0.x86\_64.rpm

8.  vmware-ca-6.7.0-0.x86\_64.rpm

9.  vmware-ic-config-6.7.0-0.x86\_64.rpm

10. vmware-sts-client-6.7.0-0.x86\_64.rpm

11. vmware-sts-6.7.0-0.x86\_64.rpm

Alternately, you can install the vmware-lightwave-server-6.7.0-0.x86\_64.rpm
...
2.  vmware-dns-client-6.7.0-0.x86\_64.rpm

3.  vmware-afd-client-6.7.0-0.x86\_64.rpm

4.  vmware-afd-6.7.0-0.x86\_64.rpm

5.  vmware-ca-client-6.7.0-0.x86\_64.rpm

6.  vmware-sts-client-6.7.0-0.x86\_64.rpm

7.  vmware-ic-config-6.7.0-0.x86\_64.rpm

Alternately, you can install the vmware-lightwave-clients-6.7.0-0.x86\_64.rpm
which is a meta RPM with dependencies on all the above RPMs.
