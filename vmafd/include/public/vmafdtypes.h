...
typedef enum {
    ...
    CDC_DC_STATE_LEGACY,
    CDC_DC_STATE_FORCE_REAFFINITIZE
...
#define VMAFD_JOIN_FLAGS_DISABLE_DNS            0x00000010
#define VMAFD_JOIN_FLAGS_ATOMIC_JOIN            0x00000020
#define VMAFD_JOIN_FLAGS_INSECURE               0x00000040
#define VMAFD_JOIN_FLAGS_MULTI_TENANTED_CA      0x00000080
