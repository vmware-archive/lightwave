...
BuildArch: x86_64
Requires:  coreutils >= 8.22, openssl >= 1.0.1, likewise-open >= 6.2.9, vmware-directory-client >= 6.0.2, vmware-afd-client >= 6.0.2, vmware-ca-client >= 6.0.2, gawk >= 4.1.0
BuildRequires: coreutils >= 8.22, openssl-devel >= 1.0.1, likewise-open-devel >= 6.2.9, vmware-directory-client-devel >= 6.0.2, vmware-afd-client-devel >= 6.0.2, vmware-ca-client-devel >= 6.0.2
