...
vmevent-client-install: $(LIGHTWAVE_STAGE_DIR)/x86_64/$(VMEVENT_CLIENT_DEVEL_RPM)
	$(RPM) -Uvh --force $(LIGHTWAVE_STAGE_DIR)/x86_64/$(VMEVENT_CLIENT_DEVEL_RPM)
...
vmdir-client-install: $(LIGHTWAVE_STAGE_DIR)/x86_64/$(VMDIR_CLIENT_RPM) $(LIGHTWAVE_STAGE_DIR)/x86_64/$(VMDIR_CLIENT_DEVEL_RPM)
	$(RPM) -Uvh --force $(LIGHTWAVE_STAGE_DIR)/x86_64/$(VMDIR_CLIENT_RPM) $(LIGHTWAVE_STAGE_DIR)/x86_64/$(VMDIR_CLIENT_DEVEL_RPM)
...
vmdns-client-install: $(LIGHTWAVE_STAGE_DIR)/x86_64/$(VMDNS_CLIENT_RPM) $(LIGHTWAVE_STAGE_DIR)/x86_64/$(VMDNS_CLIENT_DEVEL_RPM)
	$(RPM) -Uvh --force $(LIGHTWAVE_STAGE_DIR)/x86_64/$(VMDNS_CLIENT_RPM) $(LIGHTWAVE_STAGE_DIR)/x86_64/$(VMDNS_CLIENT_DEVEL_RPM)
...
vmafd-client-install: $(LIGHTWAVE_STAGE_DIR)/x86_64/$(VMAFD_CLIENT_RPM) $(LIGHTWAVE_STAGE_DIR)/x86_64/$(VMAFD_CLIENT_DEVEL_RPM)
	$(RPM) -Uvh --force $(LIGHTWAVE_STAGE_DIR)/x86_64/$(VMAFD_CLIENT_RPM) $(LIGHTWAVE_STAGE_DIR)/x86_64/$(VMAFD_CLIENT_DEVEL_RPM)
...
vmca-client-install: $(LIGHTWAVE_STAGE_DIR)/x86_64/$(VMCA_CLIENT_RPM) $(LIGHTWAVE_STAGE_DIR)/x86_64/$(VMCA_CLIENT_DEVEL_RPM)
	$(RPM) -Uvh --force $(LIGHTWAVE_STAGE_DIR)/x86_64/$(VMCA_CLIENT_RPM) $(LIGHTWAVE_STAGE_DIR)/x86_64/$(VMCA_CLIENT_DEVEL_RPM)
