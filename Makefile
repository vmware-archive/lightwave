...
vmafd-client-install: $(LIGHTWAVE_STAGE_DIR)/x86_64/$(VMAFD_CLIENT_RPM) $(LIGHTWAVE_STAGE_DIR)/x86_64/$(VMAFD_CLIENT_DEVEL_RPM) $(LIGHTWAVE_STAGE_DIR)/x86_64/$(VMAFD_CLIENT_PYTHON_RPM)
	$(RPM) -Uvh --force $(LIGHTWAVE_STAGE_DIR)/x86_64/$(VMAFD_CLIENT_RPM) $(LIGHTWAVE_STAGE_DIR)/x86_64/$(VMAFD_CLIENT_DEVEL_RPM) $(LIGHTWAVE_STAGE_DIR)/x86_64/$(VMAFD_CLIENT_PYTHON_RPM)
...
@echo "Copying samples RPM to stage"
...
@echo "Copying samples RPM to stage-2"
$(LIGHTWAVE_STAGE_DIR)/x86_64/$(VMSTS_SAMPLES_RPM):$(VMSTS_PKGDIR)/$(VMSTS_SAMPLES_RPM)
        $(CP) -f $< $@
