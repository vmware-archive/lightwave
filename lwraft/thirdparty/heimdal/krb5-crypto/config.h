...
/* path to bin */
#define BINDIR "/opt/heimdal-1.5.2/bin"
...
/* Can't use on win32, no crypt() function. */
...
/* path to lib */
#define LIBDIR "/opt/heimdal-1.5.2/lib"

/* Define if you have the libedit package. */
/* #undef LIBEDIT */

/* path to libexec */
#define LIBEXECDIR "/opt/heimdal-1.5.2/libexec"
...
#if 0 /* TBD: Adam; don't want pkinit */
...
/* path to sbin */
#define SBINDIR "/opt/heimdal-1.5.2/sbin"
