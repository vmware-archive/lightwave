...
#define RSA_SERVER_CERT LWRAFT_CONFIG_DIR VMDIR_PATH_SEPARATOR_STR "vmdircert.pem"
#define RSA_SERVER_KEY  LWRAFT_CONFIG_DIR VMDIR_PATH_SEPARATOR_STR "vmdirkey.pem"
