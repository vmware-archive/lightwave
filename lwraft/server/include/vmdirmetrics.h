...
typedef enum
{
    ...
    METRICS_LDAP_BUSY,
    METRICS_LDAP_ERROR_PRE_CONDITION,
    METRICS_LDAP_OTHER,
...
typedef enum
{
    ...
    METRICS_LAYER_REST_AUTHTOKEN_VALIDATE,
    METRICS_LAYER_REST_AUTHTOKEN_VALIDATE_POP,
    METRICS_LAYER_REST_ACCESSTOKEN_ACQUIRE,
    METRICS_LAYER_REST_HANDLER,
    METRICS_LAYER_COUNT
