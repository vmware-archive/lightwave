    ...
    )
{
    ...
    {
        dwError = VmDirEventRepoSync(pWatchSessionManager->pEventRepo, 1000);
        ...
        dwError = VmDirWatchSessionManagerActivateSessions(pWatchSessionManager);
        BAIL_ON_VMDIR_ERROR(dwError);
    }
