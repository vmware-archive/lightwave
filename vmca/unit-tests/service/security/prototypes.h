...
#ifndef _VMCA_SECURITY_PLUGIN_UNITTEST_PROTOTYPES_H_
#define _VMCA_SECURITY_PLUGIN_UNITTEST_PROTOTYPES_H_
...
#endif /* _VMCA_SECURITY_PLUGIN_UNITTEST_PROTOTYPES_H_ */
