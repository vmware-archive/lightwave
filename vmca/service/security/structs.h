...
#ifndef _VMCA_SECURITY_STRUCTS_H_
#define _VMCA_SECURITY_STRUCTS_H_

typedef struct _VMCA_SECURITY_CONTEXT
{
...
} VMCA_SECURITY_CONTEXT, *PVMCA_SECURITY_CONTEXT;

#endif /* _VMCA_SECURITY_STRUCTS_H_ */
