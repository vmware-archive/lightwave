...
PVMREST_HANDLE gpVMCAHTTPHandle = NULL;
PVMREST_HANDLE gpVMCAHTTPSHandle = NULL;

VMCA_ACCESS_TOKEN_METHODS gVMCAAccessTokenMethods[] =
{
    {VMCA_AUTHORIZATION_TYPE_BEARER_TOKEN, VMCAVerifyOIDCBearerToken, VMCAFreeOIDC},
    {VMCA_AUTHORIZATION_TYPE_HOTK_TOKEN, VMCAVerifyOIDCHOTKToken, VMCAFreeOIDC},
