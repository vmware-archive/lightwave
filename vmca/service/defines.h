...
#define VMCA_HTTP_DEBUG_LOGFILE VMCA_LOG_DIR VMCA_PATH_SEPARATOR_STR "vmca-rest-http.log"
#define VMCA_HTTPS_DEBUG_LOGFILE VMCA_LOG_DIR VMCA_PATH_SEPARATOR_STR "vmca-rest-https.log"
#define VMCA_REST_CLIENT_CNT 5
#define VMCA_REST_WORKER_TH_CNT 5

#define VMCA_REST_CONN_TIMEOUT_SEC 30
#define VMCA_MAX_DATA_PER_CONN_MB  25
#define VMCA_HTTP_DAEMON_NAME      "vmcad-http";
#define VMCA_HTTPS_DAEMON_NAME     "vmcad-https";
